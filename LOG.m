%LAPLACE
clc; clear; close all;
img = imread('bunga.jpg'); % Gantilah dengan nama file gambar
...
h = fspecial('log', [7 7], 0.5); % Kernel LoG 5x5 dengan sigma 0.5
...
imshow(edge_img), title('Hasil Thresholding LoG');
